    ...
    for i, diff in enumerate(differences):
        ...
        if diff.start_match:
            ...
            if diff.first_inner_a:
                ...
                before_to_first_a = f'<span class="adj-hd"><span class="hd-display"><span class="hd-arrow">&darr;</span> <strong>{d:.0f}</strong></span></span>'
            if diff.first_inner_b:
                d = hamming_distance(sm.b.hash, diff.first_inner_b.hash)
                before_to_first_b = f'<span class="adj-hd"><span class="hd-display"><span class="hd-arrow">&darr;</span> <strong>{d:.0f}</strong></span></span>'
            ...
            start_diff_hash = f'<div class="frame-info"><span class="hd-display"><span class="hd-arrow">&harr;</span> <strong>{start_hd:.0f}</strong></span></div>'
        ...
        if diff.end_match:
            ...
            end_diff_hash = f'<div class="frame-info"><span class="hd-display"><span class="hd-arrow">&harr;</span> <strong>{end_hd:.0f}</strong></span></div>'
        ...
        if diff.first_inner_a and diff.first_inner_b:
            ...
            first_diff_label = f'<div class="frame-info"><span class="hd-display"><span class="hd-arrow">&harr;</span> <strong>{first_hd:.0f}</strong></span></div>'
        ...
        if diff.last_inner_a:
            ...
            if diff.end_match:
                ...
                last_to_after_a = f'<span class="adj-hd"><span class="hd-display"><span class="hd-arrow">&darr;</span> <strong>{d:.0f}</strong></span></span>'
        ...
        if diff.last_inner_b:
            ...
            if diff.end_match:
                ...
                last_to_after_b = f'<span class="adj-hd"><span class="hd-display"><span class="hd-arrow">&darr;</span> <strong>{d:.0f}</strong></span></span>'
        ...
        if diff.last_inner_a and diff.last_inner_b:
            ...
            last_diff_label = f'<div class="frame-info"><span class="hd-display"><span class="hd-arrow">&harr;</span> <strong>{last_hd:.0f}</strong></span></div>'
...
<style>
  * {{ box-sizing: border-box; margin: 0; padding: 0; }}
  ...
  .hd-display {{ font-size: 1.2em; display: inline-flex; align-items: center; gap: 4px; }}
  .hd-arrow {{ font-size: 3em; line-height: 0.5; }}
